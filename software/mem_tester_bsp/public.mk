...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../nois_system.sopcinfo
...
# Design Name 
# setting SOPC_NAME is nois_system
SOPC_NAME := nois_system
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4048
SOPC_SYSID_FLAG += --sidp=0x4048
ELF_PATCH_FLAG  += --sidp 0x4048

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1416282964
SOPC_SYSID_FLAG += --timestamp=1416282964
ELF_PATCH_FLAG  += --timestamp 1416282964
